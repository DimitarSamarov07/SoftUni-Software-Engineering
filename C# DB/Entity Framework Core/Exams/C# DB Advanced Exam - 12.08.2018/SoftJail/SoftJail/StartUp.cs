namespace SoftJail
{
    ...
    public class StartUp
    {
        public static void Main(string[] args)
        {
            ...
            //var file = File.ReadAllText(projectDir + "Datasets/ImportOfficersPrisoners.xml");

            //Console.WriteLine(Serializer.ExportPrisonersInbox(context, "Melanie Simonich,Diana Ebbs,Binni Cornhill"));
        ...
        {
            var bonusOutput = DataProcessor.Bonus.ReleasePrisoner(context, 20);
