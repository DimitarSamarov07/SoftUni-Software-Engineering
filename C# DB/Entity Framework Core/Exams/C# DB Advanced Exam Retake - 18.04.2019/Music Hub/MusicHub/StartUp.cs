namespace MusicHub
{
    ...
    public class StartUp
    {
        public static void Main(string[] args)
        {
            ...
            Mapper.Initialize(cfg => cfg.AddProfile(typeof(MusicHubProfile)));
            ...
            var file = File.ReadAllText(projectDir + "Datasets/ImportSongPerformers.xml");
            Console.WriteLine(Serializer.ExportSongsAboveDuration(context,4));
