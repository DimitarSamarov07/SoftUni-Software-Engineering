    ...
    public class StartUp
    {
        static void Main()
        {
            using (var context = new PetClinicContext())
            {
                ...
                //    @"D:\GitHub Local\SoftUni-Software-Engineering\C# DB\Entity Framework Core\Exams\C# DB Advanced Retake Exam - 05.01.2018\Datasets\procedures.xml");

                //Console.WriteLine(Serializer.ExportAllProcedures(context));
